  ...
  return (
    <div className="game-container">
      <div className="game-header">
        <div className="score">🔥 Tentativas: {moves}</div>
        <div className="pairs">
          😈 Pares infernais: {matchedPairs.length}/{difficulty}
        </div>
      </div>
      ...
      {!gameStarted && (
        <div className="game-start-overlay">
          <div className="start-message">
            <h2>🔥 Reino da Capetinha 😈</h2>
            <p>Bem-vinda ao inferno fofo! Encontre os pares diabólicos!</p>
      ...
      {gameCompleted && (
        <div className="game-over-overlay">
          <div className="game-over-message">
            <h2>🔥 Capetinha expert! 🔥</h2>
            <p>Você dominou todo o inferno em {moves} tentativas diabólicas!</p>
